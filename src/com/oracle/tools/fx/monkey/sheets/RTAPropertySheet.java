...
public class RTAPropertySheet {
    public static void appendTo(OptionPane op, RichTextArea r) {
        ...
        op.option("Prompt:", createPromptOption("promptText", r.promptProperty()));
    ...
    private static ObjectOption<Object> createPromptOption(String name, ObjectProperty<Object> p) {
        ObjectOption<Object> op = new ObjectOption<>(name, p);
        op.addChoice("<null>", null);
        op.addChoice("Short Text", "Short Prompt");
        op.addChoice("Multi-Line Text",
            """
            1. Multi-Line Prompt
            2. Second Line
            3. Third Line
            """);
        op.addChoiceSupplier("Node", () -> {
            return CustomPane.create();
        });
        op.addChoice("Object", new Object());
        op.addChoice("String Supplier", new Supplier<String>() {
            @Override
            public String get() {
                return "String generated by Supplier<String>";
            }
        });
        op.addChoice("Node Supplier", new Supplier<Node>() {
            @Override
            public Node get() {
                return CustomPane.create();
            }
        });
        op.addChoice("Object Supplier", new Supplier<Object>() {
            @Override
            public Object get() {
                return new Object();
            }
        });
        op.addChoice("Supplier of <null>", new Supplier<Object>() {
            @Override
            public Object get() {
                return null;
            }
