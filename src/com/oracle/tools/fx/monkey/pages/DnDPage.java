...
public class DnDPage extends TestPaneBase {
    ...
    private ObjectOption<Image> createImageOption() {
        ...
        op.addChoice("128 x 16", ImageTools.createImage(128, 16));
        op.addChoice("16 x 128", ImageTools.createImage(16, 128));
        op.addChoice("256 x 256", ImageTools.createImage(256, 256));
        op.addChoice("4096 x 4096", ImageTools.createImage(4096, 4096));
